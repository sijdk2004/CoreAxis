      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text('CoreAxis ERP', style: theme.textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.bold)),
            ...
            const SizedBox(height: 8),
            const Text('Support: support@coreaxis.com', style: TextStyle(color: Colors.blue)),
          ],
        ),
      ),
    );
